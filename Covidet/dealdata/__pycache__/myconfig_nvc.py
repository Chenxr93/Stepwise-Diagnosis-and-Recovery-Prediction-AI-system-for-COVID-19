...
def create_parser(state=None):
    ...
    parser.add_argument('--gpu_num', type=str, default='4,5,6', help='which gpu to use')
    parser.add_argument('--init_lr', type=float, default=5e-4, help='learning rate')
    parser.add_argument('--epochs', type=int, default=20, help='Number of epochs')
    parser.add_argument('--tr_bs', type=int, default=3, help='training batch_size')
    parser.add_argument('--test_bs', type=int, default=3, help='test batch_size')
