...
class DataBowl(Dataset):
    def __init__(self, phase='train', policy = None,wh = (448,448
        ...
        self.imageAllTrue = []
        self.imageAllFalse = []
        self.savepathtrain = '/data/chenxiangru/covidData/TrainNP_5_8'
        self.savepathtest = '/data/chenxiangru/covidData/TestNP_5_8'
        ...
        if phase == 'test':
            ...
            for steps,fd in enumerate(self.image_name_positive):
                ...
                for folder in fdlist:
                    ...
                    if steps%4 == 0:
                        # for q in range(3):
                        self.imageAllTrue.append([[os.path.join(folder,i) for i in sorted(os.listdir(folder))],1.,'val'])
                    else:
                        # for q in range(3):
                        self.imageAllTrue.append([[os.path.join(folder,i) for i in sorted(os.listdir(folder))],1.,'train'])
