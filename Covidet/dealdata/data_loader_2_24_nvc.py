...
class DataBowl(Dataset):
    def __init__(self, phase='train', policy = None,wh = (256,256
        ...
        self.path_train = '/data/chenxiangru/covidData/TrainPneu'
        self.path_val = '/data/chenxiangru/covidData/TestPneu'
        self.stdmean = {
    ...
    def Rotate(self,img):
        ...
        scipy.ndimage.rotate(img, angle, axes=(0, 1), reshape=False, output=None, order=3, mode='constant', cval=0.0,
                             prefilter=True)
        return img
